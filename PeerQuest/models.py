...
class stgrp(db.Model):
    ...
    user2=db.Column(db.String(100), nullable=True, unique=True)
    user3=db.Column(db.String(100), nullable=True, unique=True)
    user4=db.Column(db.String(100), nullable=True, unique=True)
    user5=db.Column(db.String(100), nullable=True, unique=True)
